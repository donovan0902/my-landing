...
const projectDirectories: ProjectDirectory[] = [
  ...
  },
  {
    ...
    description:
      "Internal tool-sharing platform for my company. Like Reddit with a sprinkle of Product Hunt and Github. >220 users internally. Public facing demo w/mock data:",
    descriptionSuffixLink: {
